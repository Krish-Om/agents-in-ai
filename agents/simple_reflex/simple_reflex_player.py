#!/usr/bin/env python3
"""
Simple Reflex Agent Player for Snake Game
Runs the simple reflex agent that makes decisions based on immediate perceptions
"""
...
# Import the simple reflex agent function
sys.path.append(os.path.dirname(os.path.abspath(__file__)))
from simple_reflex_agent import simple_agent


class SimpleReflexPlayer:
    def __init__(self):
        self.games_played = 0
        self.total_score = 0
        self.best_score = 0
    ...
    def play_game(self, game):
        """Play one game using the simple reflex agent"""
        try:
            while True:
    ...
    def play_multiple_games(self, num_games=5, show_display=True):
        ...
        print("🤖 Simple Reflex Agent Player")
        print(f"🎯 Playing {num_games} games")
        print("📋 Strategy: Direct movement toward apple with collision avoidance")
        print("=" * 60)
    ...
    def show_statistics(self):
        ...
        print("\n" + "=" * 60)
        print("📊 SIMPLE REFLEX AGENT PERFORMANCE STATISTICS")
        print("=" * 60)
...
def main():
    ...
    player = SimpleReflexPlayer()

    print("🐍 Simple Reflex Agent for Snake Game")
    print("\nChoose an option:")
